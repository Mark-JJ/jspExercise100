...
public class MemberDao {
	...
	private static final String SELECT_BY_ID = "Select memberId, password, name, address, phone, birthday, registerdate, picture, weight from LoginNmber where memberId = ?";
